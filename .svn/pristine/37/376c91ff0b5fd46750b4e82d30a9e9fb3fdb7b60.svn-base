 ...
 * 
 */
public class PicViewer extends FrameLayout implements OnPageChangeListener {
    ...
    public PicViewer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
            ...
            viewImg.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (null != onPageViewClick) {
                        onPageViewClick.onPageViewClick(index);
                    }
                }
            });
