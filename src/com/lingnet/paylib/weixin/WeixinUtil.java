...
public class WeixinUtil {
    ...
    public static byte[] httpPost(String url, String entity) {
        if (url == null || url.length() == 0) {
            LogUtils.e("httpPost, url is null");
            return null;
        }
        ...
        try {
            ...
            LogUtils.e("httpPost exception, e = " + e.getMessage());
            e.printStackTrace();
            return null;
        }
    }
    ...
    public static byte[] readFromFile(String fileName, int offset, int len) {
        ...
        LogUtils.d("readFromFile : offset = " + offset + " len = " + len + " offset + len = "
                        + (offset + len));
    ...
    public static Bitmap extractThumbNail(final String path, final int height, final int width,
        ...
        try {
            ...
            LogUtils.i("bitmap required size=" + newWidth + "x" + newHeight + ", orig="
            ...
            if (crop) {
                final Bitmap cropped =
                                Bitmap.createBitmap(bm, (bm.getWidth() - width) >> 1,
