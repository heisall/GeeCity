...
public class ResetPwdVerfiyPhoneActivity extends ActionBarActivity {
    ...
    @ViewInject(R.id.btn_reset_verfiy_get)
    private Button mBtnGetCode;
    @ViewInject(R.id.btn_reset_pwd_commit)
    private Button mBtnGetCommit;
    @ViewInject(R.id.et_reset_phone)
    private EditText mEtPhone;
    @ViewInject(R.id.et_reset_verfiy_code)
    private EditText mEtCode;
    
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_reset_verfiy_code);
    ...
    @OnClick({R.id.btn_home_menu, R.id.btn_home_message, R.id.btn_reset_verfiy_get,
                    R.id.btn_reset_verfiy_commit})
    public void OnClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_home_message: //
                break;
            case R.id.btn_reset_verfiy_get: // 获取验证码
                ...
                break;
            case R.id.btn_reset_verfiy_commit: // 提交
    			...
    			if(mVerfyCode.equals(mEtCode.getText().toString().trim())){
    				...
    				startNextActivity(b, ResetPwdActivity.class);
    			}else{
