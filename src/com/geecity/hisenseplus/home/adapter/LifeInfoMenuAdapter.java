 ...
 * 房屋列表
 * */
public class LifeInfoMenuAdapter extends BaseAdapter {

	Context context;
	private LinkedList<MallMenuBean> menus;

	public LifeInfoMenuAdapter(Context context) {
	...
	public View getView(final int position, View convertView,
			ViewGroup parent) {
		if (null == convertView) {
			convertView = LayoutInflater.from(context).inflate(R.layout.item_life_gridview, null);
		}
