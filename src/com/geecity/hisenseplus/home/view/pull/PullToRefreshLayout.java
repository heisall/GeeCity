package com.geecity.hisenseplus.home.view.pull;
...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        refreshingAnimation =
                (RotateAnimation) AnimationUtils.loadAnimation(context, R.anim.rotating);
        // 添加匀速转动动画
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            // 根据下拉距离改变比例
            radio =
                    (float) (2 + 2 * Math.tan(Math.PI / 2 / getMeasuredHeight()
                            * (pullDownY + Math.abs(pullUpY))));
            requestLayout();
